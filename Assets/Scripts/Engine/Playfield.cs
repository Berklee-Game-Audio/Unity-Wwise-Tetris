...
namespace TetrisEngine
{
    ...
    public class Playfield
    {
        ...
        //If possible, makes the current piece fall, else locks the piece in the playfield and check for full lines
        ...
        //Check if the movement is valid before it occours.
